...
def update_stats(m): #m = how many days back of data do you want to append to dataframe
	for y in range(m):
		days_back = today - timedelta(days = y+1) #Number of days back before last update as datetime object. Minus 1 because x_days_back is back to LAST entry day
		...
		add_old_dict_to_new_dict(days_back_stats)
	return 
...
df.to_excel("/Users/azima/Desktop/Python_Fun_Scripts/Azim_CICO/dictionaryoutput/outputtest.xlsx","Sheet1")
